...
export default function Landing() {
  return (
    <div style={{ fontFamily: "'Courier New', monospace", background: '#f5f1e8', color: '#1a1a1a', minHeight: '100vh' }}>
      <Head>
        <title>Free AI Text Tools for India - Summarize, Generate, Extract, Proofread | Deskwork</title>
        <meta name="description" content="Summarize articles, generate blog posts and emails, extract data from GST invoices and photos, and proofread writing - free AI tools built for Indian freelancers, students, and small businesses. No card required." />
        <meta name="keywords" content="AI summarizer India, extract data from invoice online, GST invoice data extraction, AI proofreading tool, free AI text tools, generate blog post AI, summarize PDF free" />
        <link rel="canonical" href="https://deskworkapp.in/" />
        <meta property="og:title" content="Deskwork - Free AI Text Tools Made for India" />
        <meta property="og:description" content="Summarize, generate, extract, and proofread text with four simple AI tools. Free to start, no card required." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://deskworkapp.in/" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Deskwork - Free AI Text Tools Made for India" />
        <meta name="twitter:description" content="Summarize, generate, extract, and proofread text with four simple AI tools. Free to start, no card required." />
      </Head>
